...
By default, `llama-server` will listen on port `8080`; the port the example app
is configured to use.

Clone this repo and from the repository root folder run:

```shell
cargo run --bin llamacpp-gemma4-e4b-completion
```
